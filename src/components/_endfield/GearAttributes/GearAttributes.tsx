...
export default function GearAttributes({ gear, image }: GearInfoProps) {
            ...
            <FlexBox spacing={2} sx={{ alignItems: "flex-start" }}>
                ...
                <Stack spacing={1}>
                    ...
                    <FlexBox spacing={1} wrap>
                        <InfoChip
                            title={`${toTitleCase(gear.type)}`}
                            icon={`endfield/icons/gear/${gear.type}`}
                            iconProps={{ size: 20 }}
                        />
                        <InfoChip title={`Level ${gear.level}`} />
                        <InfoChip title={gear.region} />
                    </FlexBox>
                </Stack>
            </FlexBox>
            <Box
