export type WuWaWeaponBaseATK = keyof typeof baseATKScaling;
...
export type WuWaWeaponSubStat = (typeof weaponSubStats)[number];

type WuWaWeaponSubStatInfo = Partial<Record<WuWaWeaponSubStat, string[]>>;

export const subStats: Record<WuWaWeaponBaseATK, WuWaWeaponSubStatInfo> = {
    "54": {
...
export function formatWeaponStats(stat: WuWaWeaponSubStat) {
    switch (stat) {
        case "ATK":
        case "HP":
        case "DEF":
