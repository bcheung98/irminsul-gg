export const combatRoles = [
    ...
    },
    {
        ...
        color: "#ff7777",
        icon: "wuwa/icons/tags/D7",
    },
    {
        name: "Heavy Attack DMG Amplification",
        description:
            "Provides Heavy Attack DMG Amplification for a specific Resonator in the team",
        color: "#ff7777",
        icon: "wuwa/icons/tags/D8",
    },
    {
        name: "Resonance Skill DMG Amplification",
        description:
            "Provides Resonance Skill DMG Amplification for a specific Resonator in the team",
        color: "#ff7777",
        icon: "wuwa/icons/tags/D9",
    },
    {
        name: "Resonance Liberation DMG Amplification",
        description:
            "Provides Resonance Liberation DMG Amplification for a specific Resonator in the team",
        color: "#ff7777",
        icon: "wuwa/icons/tags/D10",
    },
    {
        name: "Coordinated Attack DMG Amplification",
        description:
            "Provides Coordinated Attack DMG Amplification for a specific Resonator in the team",
        color: "#ff7777",
        icon: "wuwa/icons/tags/D11",
    },
    {
        name: "Echo Skill DMG Amplification",
        description:
            "Provides Echo Skill DMG Amplification for a specific Resonator in the team",
        color: "#ff7777",
        icon: "wuwa/icons/tags/D12",
    },
    {
        name: "Havoc Bane",
        description: "Utilizes Havoc Bane for combat advantage",
        color: "#77adff",
        icon: "wuwa/icons/tags/E1",
    },
    {
        name: "Glacio Chafe",
        description: "Utilizes Glacio Chafe for combat advantage",
        color: "#77adff",
        icon: "wuwa/icons/tags/E2",
    },
    {
        name: "Aero Erosion",
        description: "Utilizes Aero Erosion for combat advantage",
        color: "#77adff",
        icon: "wuwa/icons/tags/E3",
    },
    {
        name: "Spectro Frazzle",
        description: "Utilizes Spectro Frazzle for combat advantage",
        color: "#77adff",
        icon: "wuwa/icons/tags/E4",
    },
    {
        name: "Fusion Burst",
        description: "Utilizes Fusion Burst for combat advantage",
        color: "#77adff",
        icon: "wuwa/icons/tags/E5",
    },
    {
        name: "Electro Flare",
        description: "Utilizes Electro Flare for combat advantage",
        color: "#77adff",
        icon: "wuwa/icons/tags/E6",
    },
    {
        name: "Off-Tune Buildup Efficiency",
        description:
            "Boosts the Off-Tune Buildup Rate for a specific Resonator in the team",
        color: "#ff7777",
        icon: "wuwa/icons/tags/G1",
    },
    {
        name: "Tune Break Boost",
        description:
            "Provides additional Tune Break Boost for a specific Resonator in the team",
        color: "#ff7777",
        icon: "wuwa/icons/tags/G2",
    },
    {
        name: "Tune Strain Response",
        description: "Gains total DMG increase from Tune Break Boost",
        color: "#ff7777",
        icon: "wuwa/icons/tags/H1",
    },
    {
        name: "Tune Rupture Response",
        description: "Deals Tune Rupture DMG to targets",
        color: "#ff7777",
