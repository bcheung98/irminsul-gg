export type GenshinWeaponBaseATK = keyof typeof baseATKScaling;
...
export type GenshinWeaponSubStat = keyof typeof weaponSubStats;
...
type GenshinWeaponSubStatInfo = Partial<Record<GenshinWeaponSubStat, string[]>>;

export const subStats: Record<GenshinWeaponBaseATK, GenshinWeaponSubStatInfo> = {
    "49": {
    ...
    "45": {
        ...
        "CRIT Rate": ["2.0%", "3.5%", "3.5%", "5.2%", "5.2%", "6.0%", "6.0%", "6.8%", "6.8%", "7.6%", "7.6%", "8.4%", "8.4%", "9.2%"],
        "CRIT DMG": ["4.0%", "7.0%", "7.0%", "10.4%", "10.4%", "12.0%", "12.0%", "13.6%", "13.6%", "15.2%", "15.2%", "16.8%", "16.8%", "18.4%"],
