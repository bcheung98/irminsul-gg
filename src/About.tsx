        ...
        >
            <Box>
                ...
                <Typography sx={body} component="span">
                    The majority of the site's visual cleanup has been finished! (Fun fact: adding the left navbar alone actually ended up messing up much of the sites' layout.) There will be additional visual cleanups intermittently in the future as I cleanup and refactor much of the site's components.<br />I will be moving on to mobile formatting next, and will be shelving a dark and light theme switcher for later. To me, having the site be accessible on a mobile device is much more important than being able to switch themes (and who uses light mode anyways).<br /><br />
                    - BC (10/8/2024)
                </Typography>
            </Box>
            <Divider sx={{ my: "20px" }} />
            <Box>
                ...
                <Typography sx={body} component="span">
                    ...
                    I can't really give you an exact timeframe of when each of these milestones will be completed (because I suck at figuring out how long things will take), but I'll be extremely generous and say I'll have this all done by the end of November. If it isn't done by then, I'll just say Soon™.<br /><br />
                    - BC (9/23/2024)
                </Typography>
            </Box>
            <Divider sx={{ my: "20px" }} />
