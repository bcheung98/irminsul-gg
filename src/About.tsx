...
function About() {
    ...
    return (
        ...
        >
            <Box>
                <Typography variant="h4" sx={{ mb: "30px" }}>Visual touchups done!</Typography>
                <Typography>The majority of the site's visual cleanup has been finished! (Fun fact: adding the left navbar alone actually ended up messing up much of the sites' layout.) There will be additional visual cleanups intermittently in the future as I cleanup and refactor much of the site's components.<br />I will be moving on to mobile formatting next, and will be shelving a dark and light theme switcher for later. To me, having the site be accessible on a mobile device is much more important than being able to switch themes (and who uses light mode anyways).
                </Typography><br />
                <Typography>- BC (10/8/2024)</Typography>
            </Box>
            <Divider sx={{ my: "20px" }} />
            <Box>
