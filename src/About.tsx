        ...
        >
            ...
            <Box>
                ...
                <Typography sx={body} component="span">
                    ...
                    <br /><br />
                    So...what's next for the site? There's two big things I want to do; one of those things is to rebuild the sites with an updated and more consistent codebase. The reason why I want to do this is since I've worked on this project for so long, I will naturally learn new skills over time and implement them into whichever site I was working on at the time. To save time, I often don't end up transferring whatever new thing I implemented across the other sites. As a result, even though the three websites are mostly identical in appearance and functionality, the code behind them can be vastly different, which I would like to avoid. I figured that the best way to rebuild the sites is to just start from scratch, and if I'm going to start from scratch, I might as well start working on something new. This leads to the other big thing I want to do next: a site for Zenless Zone Zero.
                    <br /><br />
                    My plan is to make a website for ZZZ that uses all the new skills and tools I've learned over the years, and then have the codebase of the ZZZ site be the new template for all the other sites. This means that any major changes to the Genshin, HSR, and WuWa sites won't be done until the majority of the ZZZ site is finished. Both the ZZZ site and the code rebuilding will take quite a lot of time, but I plan to have features of the ZZZ site be released bit by bit (so you don't have to wait for the entire thing). I will probably take a short break from working on Irminsul.GG to take care of other projects and life, but expect a ZZZ site to be available Soon™.
                    <br /><br />
                    Once again, I don't know if anyone will actually use this site (other than myself and friends I show this to), but if it somehow gets popular and people need to contact me for feedback and/or to report issues, I can set something up for that (probably Discord). If you are reading this and made it to the end, thank you!
                    <br /><br />
                    - BC (11/22/2024)
                </Typography>
            </Box>
